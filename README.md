...
**Data Science & ML**
`NumPy` `pandas` `scikit-learn` `matplotlib` `Data Preprocessing`

**Databases**
`SQL` `Oracle Database 11g`

**Tools & Platforms**
`Git` `GitHub` `Jupyter Notebook` `Google Colaboratory` `Spyder` `Antigravity`
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-000000?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/sohaib-dakhlallah-295b791b5/)
